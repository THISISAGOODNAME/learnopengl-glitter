...
#pragma region "object_initialization"
	...
	GLuint containerTexture = loadTexture("container2.jpg");
	...
	if (glCheckFramebufferStatus(GL_FRAMEBUFFER) != GL_FRAMEBUFFER_COMPLETE)
		std::cout << RED << "Framebuffer hdrFBO not complete!" << RESET << std::endl;
	...
	for (GLuint i = 0; i < 2; i++)
	{
		...
		if (glCheckFramebufferStatus(GL_FRAMEBUFFER) != GL_FRAMEBUFFER_COMPLETE)
			std::cout << RED << "Framebuffer pingpong not complete!" << RESET << std::endl;
	}
